...
void setup() {
  ...
  setBitToArray(discrete_input_contact_list, 5, 1);
  setBitToArray(discrete_input_contact_list, 8, 1);
  setBitToArray(discrete_input_contact_list, 10, 1);
  setBitToArray(discrete_input_contact_list, 20, 1);
  setBitToArray(discrete_input_contact_list, 25, 1);
  setBitToArray(discrete_input_contact_list, 45, 1);
  // assign value to holding register memory ---------------------------
}
