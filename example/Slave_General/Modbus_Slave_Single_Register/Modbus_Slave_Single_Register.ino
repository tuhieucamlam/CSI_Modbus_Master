...
void loop() {
  ...
  if(Serial.available() > 0)
  {
    ...
    my_soft.print(analog_output_holding_register_list[0]);
    my_soft.print('\t');
    my_soft.print(analog_output_holding_register_list[1]);
    my_soft.print('\t');
    my_soft.print(analog_output_holding_register_list[2]);
    my_soft.print('\t');
    my_soft.print(analog_output_holding_register_list[3]);
    my_soft.print('\t');
    my_soft.print(analog_output_holding_register_list[4]);
    my_soft.print('\t');
    my_soft.print(analog_output_holding_register_list[5]);
    my_soft.print('\t');
    my_soft.print(analog_output_holding_register_list[6]);
    my_soft.println();
