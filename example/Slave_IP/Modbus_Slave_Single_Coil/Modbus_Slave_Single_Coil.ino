  ...
  if(new_client)
  {
    ...
    { 
      if(new_client.available())
      {
        ...
        Serial.write(discrete_output_coil_list[0]);
        Serial.write(discrete_output_coil_list[1]);
        Serial.write(discrete_output_coil_list[2]);
        Serial.write(discrete_output_coil_list[3]);
        Serial.write(discrete_output_coil_list[4]);
