  ...
  if(new_client)
  {
    ...
    { 
      if(new_client.available())
      {
        ...
        Serial.println(analog_output_holding_register_list[0]);
        Serial.println(analog_output_holding_register_list[1]);
        Serial.println(analog_output_holding_register_list[2]);
        Serial.println(analog_output_holding_register_list[3]);
        Serial.println(analog_output_holding_register_list[4]);
        Serial.println(analog_output_holding_register_list[18]);
        Serial.println();
