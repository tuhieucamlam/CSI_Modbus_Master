...
void setup() {
  ...
  setBitToArray(discrete_input_contact_list, 0, 1);
  setBitToArray(discrete_input_contact_list, 9, 1);
  // assign value to holding register memory ---------------------------
}
  ...
  if(new_client)
  {
    ...
    { 
      if(new_client.available())
      {
        ...
        setBitToArray(discrete_input_contact_list, 0, !getBitFromArray(discrete_input_contact_list, 0));
        setBitToArray(discrete_input_contact_list, 9, !getBitFromArray(discrete_input_contact_list, 9));
