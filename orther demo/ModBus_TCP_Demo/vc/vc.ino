...
char station_ssid[] = "Autobase VN";
char station_pass[] = "ATC@Scada";
...
void setup() {
  ...
  setBitToArray(discrete_output_coil_list, 0, 1);
  setBitToArray(discrete_output_coil_list, 9, 1);
  ...
  if(new_client)
  {
    ...
    { 
      if(new_client.available())
      {
        ...
        setBitToArray(discrete_output_coil_list, 0, !getBitFromArray(discrete_output_coil_list, 0));
        setBitToArray(discrete_output_coil_list, 9, !getBitFromArray(discrete_output_coil_list, 9));
